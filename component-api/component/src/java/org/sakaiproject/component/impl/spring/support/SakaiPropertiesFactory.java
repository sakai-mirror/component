/**********************************************************************************
*
* $Id: SakaiProperties.java 37753 2007-11-05 21:10:09Z ray@media.berkeley.edu $
*
***********************************************************************************
*
 ...
 */
public class SakaiPropertiesFactory implements BeanFactoryPostProcessorCreator, InitializingBean {
	private static Log log = LogFactory.getLog(SakaiPropertiesFactory.class);
	...
	public BeanFactoryPostProcessor[] getBeanFactoryPostProcessors() {
		return new BeanFactoryPostProcessor[] {propertyOverrideConfigurer, propertyPlaceholderConfigurer};
	}
